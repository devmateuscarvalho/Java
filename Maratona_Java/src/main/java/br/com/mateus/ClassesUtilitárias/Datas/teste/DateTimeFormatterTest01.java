...
public class DateTimeFormatterTest01 {
    public static void main(String[] args) {
        ...
        LocalDate parse1 = LocalDate.parse("20210219", DateTimeFormatter.ISO_LOCAL_DATE);
        LocalDate parse2 = LocalDate.parse("2021-02-19+05:00", DateTimeFormatter.ISO_LOCAL_DATE);
        ...
        System.out.println(parse4+"parse 4");
    }
}
